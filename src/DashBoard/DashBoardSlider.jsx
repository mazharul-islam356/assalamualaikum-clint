        ...
        <ul className="nav-list">
          ...
          <li>
            <Link to='employee-salary' className="a">
              ...
              <span className="link_name">বেতন ও আনুষঙ্গিক খরচ</span>
            </Link>
            <span className="tooltip">বেতন ও আনুষঙ্গিক খরচ</span>
          </li>

          <li>
            <Link to='dharAmount' className="a">
            <i className='bx bx-wallet-alt'></i>
              <span className="link_name">ধারকৃত টাকার হিসাব</span>
            </Link>
            <span className="tooltip">ধারকৃত টাকার হিসাব</span>
          </li>
